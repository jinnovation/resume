...
\documentclass[alternative,10pt,compact,monochrome]{yaac-another-awesome-cv}
...
\begin{experiences}
  ...
  \experiencewithblurb
      ...
      {Member of ML Platform. Working on: centralized, multi-tenant ML
        ...
        \href{http://kubeflow.org/}{Kubeflow}; and user-facing
  ...
  \experiencewithblurb
      ...
      {Member of AI Infrastructure. Contributor to
        \href{https://blogs.nvidia.com/blog/2018/09/13/how-maglev-speeds-autonomous-vehicles-to-superhuman-levels-of-safety/}{MagLev},
  ...
  \experiencewithblurb
      ...
      {New York}
      {08/2018}
      {Member of \href{http://cortex.twitter.com}{Cortex}, Twitter's central ML
