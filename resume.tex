...
\experiencewithblurb
    ...
    }
    {
      \begin{itemize}
        ...
        \item Driving the development of governance infrastructure for machine
          learning; implementing systematic traceability and lineage-tracking
          for production ML models; developing Backstage-based org-wide
          standards for documentation and registration of ML models and systems;
